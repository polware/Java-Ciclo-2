public class ArrayOfObjects {
    public static void main(String args[]){  
        ...
        System.out.println("Producto Objeto 1:");  
        obj[0].display();  
        System.out.println("Producto Objeto 2:");  
        obj[1].display();  
        System.out.println("Producto Objeto 3:");  
        obj[2].display();  
        System.out.println("Producto Objeto 4:");  
        obj[3].display();  
        System.out.println("Producto Objeto 5:");  
        obj[4].display();  
    }  
}
...
class Product  {  
    ...
    public void display()  
        {  
        System.out.print("ID del Producto= "+pro_Id + "  " + " Nombre del Producto= "+pro_name);
        System.out.println();
    }
}
